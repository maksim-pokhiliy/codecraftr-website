...
const services = [
  {
    ...
    subtitle: "8-12 weeks",
    description:
      "Build and validate your SaaS idea with production-ready MVP using MERN stack and scalable architecture.",
  ...
  },
  {
    ...
    description:
      "Specialized booking systems with real-time availability and payment processing backed by travel expertise.",
...
export function ServicesSection() {
  return (
    <Section title="Our" highlighted="services." variant="dark">
